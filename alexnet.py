...
from keras.layers import Dense, Flatten, Dropout, ZeroPadding2D, BatchNormalization, Activation
# Other
...
parser.add_argument('--num_epochs', type=int, default=30, help='Number of epochs to train for')#10               #
...
parser.add_argument('--resize_height', type=int, default=227, help='Height of cropped input image to network')#VGG19 331 #224
parser.add_argument('--resize_width', type=int, default=227, help='Width of cropped input image to network')
...
parser.add_argument('--model', type=str, default="AlexNet", help='Your pre-trained classification model of choice')#28 0.7681#
...
# Prepare the model
model = Sequential()
model.add(Conv2D(96, (11, 11), strides=(4, 4),input_shape = (227,227,3), padding='valid', activation=None,kernel_initializer='uniform'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(3, 3), strides=(2, 2)))
model.add(ZeroPadding2D(padding=(2, 2)))
model.add(Conv2D(256, (5, 5), strides=(1, 1), padding='valid', activation=None, kernel_initializer='uniform'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(3, 3), strides=(2, 2)))
